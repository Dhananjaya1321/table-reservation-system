    ...
    return (
        <section className="w-[100%] h-[100vh] flex flex-col items-center justify-center bg-gray-100">
            <div className="w-[280px] sm:w-[400px] h-max bg-white p-[20px] rounded-[15px] shadow-2xl flex flex-col justify-center">
                ...
                <p className="mt-1">Welcome to our easy table booking site If you don't have an account please SignUp</p>
                ...
                <p className="text-center mt-3">Do you already have an account? <button className="text-blue-600">SignIn</button></p>
            </div>
        </section>
    );
}