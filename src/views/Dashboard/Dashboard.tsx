...
export function Dashboard() {
    return (
        <section className="mt-[400px] sm:mt-10 absolute left-[50px] right-0 sm:left-0 sm:relative flex flex-row justify-center items-center h-max gap-[25px] flex-wrap">
